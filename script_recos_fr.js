...
function fetchSeries() {
    ...
    fetch('http://localhost/saes5/test_api3.php/user/recos', {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        ...
        if (data.length == 0 || data == null){
            alert("Vous n'avez pas encore assez de données pour avoir des recommandations. Likez des séries pour en avoir !");
        }
